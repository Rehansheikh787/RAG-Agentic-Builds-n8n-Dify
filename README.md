...
**[Ingestion Agent](assets/RAG Ingestion -Agent.json) . [Retrieval Agent](assets/RAG Chat - Supabase Retrieval Agent.json) . [Defy HR Agent](assets/HR Policy Assistant dify.yml)**
